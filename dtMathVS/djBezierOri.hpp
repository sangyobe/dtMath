...
template <int mrow, int ncol>
class Bezier
{
public:

    float BinomialCoeff(int n, int k);
    float BernsteinPoly(int n, int k, float ctrlParam);
...
template <int mrow, int ncol>
float Bezier<mrow, ncol>::BinomialCoeff(int n, int k)
{
    if (n < k) return 0;
...
template <int mrow, int ncol>
float Bezier<mrow, ncol>::BernsteinPoly(int n, int k, float ctrlParam)
{
