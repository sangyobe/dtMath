...
#####################################################################
#
# Modified by joonhee Jo on 23. 2. 15.
# Copyright (c) 2023 HMC Robotics Labs. All rights reserved.
#
#
#
#.rst:
...
macro(FindOrFetch)
	...
	if(NOT _ARGS_TARGETS)
		message(FATAL_ERROR "FindOrFetch: TARGETS must be specified.")
	endif()

	set(targets_found TRUE)
	message(CHECK_START
					"FindOrFetch: checking for targets in package `${_ARGS_PACKAGE_NAME}`"
	)
	...
	if(NOT targets_found)
		if(${_ARGS_USE_SYSTEM_PACKAGE})
			message(CHECK_START
							"FindOrFetch: finding `${_ARGS_PACKAGE_NAME}` in system packages..."
			)
			find_package(${_ARGS_PACKAGE_NAME} REQUIRED)
			message(CHECK_PASS "found")
		else()
			message(CHECK_START
							"FindOrFetch: Using FetchContent to retrieve `${_ARGS_LIBRARY_NAME}`"
			)
			if(EXTERNAL_LIBRARY_FETCH_PATH)
				set(FETCHCONTENT_BASE_DIR ${EXTERNAL_LIBRARY_FETCH_PATH}/${_ARGS_LIBRARY_NAME})
			endif()
