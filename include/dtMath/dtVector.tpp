...
inline void Vector<t_row, t_type>::SetBlock(const uint16_t idxRow, const Vector<row, t_type> &v)
{
...
template <uint16_t t_row, typename t_type>
inline void Vector<t_row, t_type>::SetBlock(const uint16_t idxRow, const Vector3<t_type, 3> &v)
{
    assert(t_row > idxRow && "Index out of range");
...
template <uint16_t t_row, typename t_type>
inline void Vector<t_row, t_type>::SetBlock(const uint16_t idxRow, const Vector4<t_type, 4> &v)
{
    assert(t_row > idxRow && "Index out of range");
...
template <uint16_t t_row, typename t_type>
inline void Vector<t_row, t_type>::SetBlock(const uint16_t idxRow, const Vector6<t_type, 6> &v)
{
    assert(t_row > idxRow && "Index out of range");
...
template <uint16_t t_row, typename t_type>
template <uint16_t row>
inline void Vector<t_row, t_type>::SetBlock(const uint16_t idxRow, const Matrix<row, 1, t_type> &v)
{
    assert(t_row > idxRow && "Index out of range");
...
template <uint16_t t_row, typename t_type>
inline void Vector<t_row, t_type>::SetBlock(const uint16_t idxRow, const Matrix<0, 0, t_type> &v)
{
    assert(t_row > idxRow && "Index out of range");
    assert(v.m_elem != nullptr && "Memory has not been allocated");
    assert(v.m_col == 1 && "Col dimensions do not matched");
...
template <uint16_t t_row, typename t_type>
inline void Vector<t_row, t_type>::SetBlock(const uint16_t idxRow, const Vector<0, t_type> &v)
{
    assert(t_row > idxRow && "Index out of range");
    assert(v.m_elem != nullptr && "Memory has not been allocated");
...
template <uint16_t t_row, typename t_type>
template <uint16_t row>
inline Vector<row, t_type> Vector<t_row, t_type>::GetBlock(const uint16_t idx)
{
...
template <uint16_t t_row, typename t_type>
inline Vector<0, t_type> Vector<t_row, t_type>::GetBlock(const uint16_t idx, const uint16_t row)
{
    assert(t_row > idx && "Index out of range");
...
template <uint16_t t_row, typename t_type>
inline Vector3<t_type, 3> Vector<t_row, t_type>::GetBlockVec3(const uint16_t idx)
{
    assert(t_row > idx && "Index out of range");
...
template <uint16_t t_row, typename t_type>
inline Vector4<t_type, 4> Vector<t_row, t_type>::GetBlockVec4(const uint16_t idx)
{
    assert(t_row > idx && "Index out of range");
...
template <uint16_t t_row, typename t_type>
inline Vector6<t_type, 6> Vector<t_row, t_type>::GetBlockVec6(const uint16_t idx)
{
    assert(t_row > idx && "Index out of range");
...
template <uint16_t t_row, typename t_type>
template <uint16_t row>
inline int8_t Vector<t_row, t_type>::GetBlock(const uint16_t idx, Vector<row, t_type> &v)
{
    assert(t_row > idx && "Index out of range");
...
template <uint16_t t_row, typename t_type>
inline int8_t Vector<t_row, t_type>::GetBlock(const uint16_t idx, Vector<0, t_type> &v)
{
    assert(t_row > idx && "Index out of range");
    assert(v.m_elem != nullptr && "Memory has not been allocated");
...
template <uint16_t t_row, typename t_type>
inline int8_t Vector<t_row, t_type>::GetBlockVec3(const uint16_t idx, Vector3<t_type, 3> &v)
{
    assert(t_row > idx && "Index out of range");
...
template <uint16_t t_row, typename t_type>
inline int8_t Vector<t_row, t_type>::GetBlockVec4(const uint16_t idx, Vector4<t_type, 4> &v)
{
    assert(t_row > idx && "Index out of range");
...
template <uint16_t t_row, typename t_type>
inline int8_t Vector<t_row, t_type>::GetBlockVec6(const uint16_t idx, Vector6<t_type, 6> &v)
{
    assert(t_row > idx && "Index out of range");
