...
public:
    ...
    t_type Inner(const Vector3<t_type, t_row> &v) const;   // vector1 * vector2 inner(dot) product
    t_type Inner(const Vector4<t_type, t_row> &v) const;   // vector1 * vector2 inner(dot) product
    t_type Inner(const Vector6<t_type, t_row> &v) const;   // vector1 * vector2 inner(dot) product
