...
#ifndef DTMATH_DTGNU_PLOT_TPP_
#define DTMATH_DTGNU_PLOT_TPP_
...
inline int8_t dtGnuPlot<m_type>::SetData(const dtMatrix<row, col, m_type> &mat)
{
    // file name
    FILE *fp;
